...
public class SlidingBlocks extends JPanel{ //jpanel disegna la griglia in un pannello dedicato
	...
	public String instance= " ";	//qua vanno inserite le celle ( cio� i fatti ) dopo che � stato fatto lo shuffle, NB non dimenticare di aggiornare questo file ogni volta che si esegue un movimento delle celle. Vedi funzione setInstance
